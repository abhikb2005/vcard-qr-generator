...
| `error_qr_generation` | QR generation or render fails on static, branded, or dynamic QR creation paths. | `qr_type`, `error_message`, `source_page` | Makes broken generation states visible without collecting contact data. | No |
